...
// Immediate sign-extension for all RV32I immediate formats; used by EX stage to generate ALU input B
...
module extend (
    ...
    // Expand the immediate field selected by the controller into a full 32-bit value.
    always_comb
        case (immsrc)
